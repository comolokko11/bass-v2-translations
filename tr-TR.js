lang = {
    ...
    HELP_TITLE: 'Bass Yardım Menüsü',
    HELP_LINKS: 'Linkler',
    HELP_SUPPORT_SERVER: 'Destek Sunucusu',
    HELP_INVITE: 'Davet et',
    HELP_VOTE: 'Oyla',
    // STATS
    ...
    QUEUE_NO: 'Hayır',
    QUEUE: 'Sıra:',
    SKIP_DESCRIPTION: 'Şu anki oynatılan şarkıyı geçer',
    SKIPPED: 'Şarkı Geçildi.',
    STOP_DESCRIPTION: 'Şarkıyı kapatır, sırayı temizler ve sesli kanaldan ayrılır.',
    STOPPED: 'Kapatıldı.',
    PREV_DESCRIPTION: 'Son çalınan şarkıyı gösterir',
    RECENTLY_PLAYED: 'En son oynatılan:',
    VOLUME_DESCRIPTION: 'Ses seviyesini değiştirir',
    ...
    PLAY_DESCRIPTION: 'Şarkıyı oynatır',
    ...
    // RELOAD
    RELOAD_DESCRIPTION: 'Bass\'ı yeniler',
    RELOADED: 'Yenilendi',
    ...
    YOU_DIDNT_VOTE: 'Oy vermediniz!',
    VOTED_MESSAGE: (mention, date, votes) => `Son 12 saat içinde Bass için oy verdin!\nBass\'ı desteklediğin için teşekkürler ${mention}!\nOy verme tarihin: \`${date}\`\nBass\'a ${votes} defa oy verdiniz.\n\n[Oylama linki](https://top.gg/bot/590948209925423123/vote)`,
    NOT_VOTED_MESSAGE: (date, votes) => `Son 12 saatte Bass\'a oy vermediniz :(\nSon verdiğin oyun tarihi: \`${date}\`\nBass\'a ${votes} defa oy verdiniz.\n\nBass\'a oy verebilirsin [buradan](https://top.gg/bot/590948209925423123/vote).`,
    // STUFF FOR NEW HELP
    ...
    HELP_CMD_DESCRIPTION: 'Açıklama',
    HELP_REQUIRED_PERMS: 'Gerekli izinler',
    HELP_BOT_REQUIRED_PERMS: 'Bass tarafından gerekli izinler',
    HELP_COOLDOWN_TITLE: 'Bekleme süresi',
    HELP_COOLDOWN: (uses, seconds) => `${uses} use${uses === 1 ? '' : 's'} per ${seconds} second${seconds === 1 ? '' : 's'}`,
    HELP_EXAMPLECOMMANDUSAGE: 'Örnek kullanım',
    HELP_EXAMPLECOMMANDUSAGE_OPTIONAL_REQUIRED: '() - isteğe bağlı, <> - gerekli',
    HELP_EXAMPLEUSAGE: ' (komut)',
    EVAL_EXAMPLEUSAGE: ' <kod>',
    SAY_EXAMPLEUSAGE: ' <mesaj>',
    TTS_EXAMPLEUSAGE: ' <mesaj> | <dil kodu>',
    LANG_EXAMPLEUSAGE: ' (dil)',
    PREFIX_EXAMPLEUSAGE: ' (prefix)',
    BITRATE_EXAMPLEUSAGE: ' <bitrate>',
    LOOP_EXAMPLEUSAGE: ' <loop tipi>',
    PLAY_EXAMPLEUSAGE: ' <şarkı ismi ya da url>',
    VOLUME_EXAMPLEUSAGE: ' (ses seviyesi)',
